...
class TestSSNDetection:
    ...
    def test_ssn_format_xxxxxxxxx(self):
...
class TestPhoneDetection:
    ...
    def test_phone_formats(self, phone):
...
class TestDOBDetection:
    ...
    def test_dob_formats(self, dob):
        """Test various DOB formats."""
        deidentifier = Deidentifier()
        text = f"Born on {dob}"
        matches = deidentifier.detect(text)
        
        dob_matches = [m for m in matches if m.type == SensitiveInfoType.DATE_OF_BIRTH]
...
class TestBatchProcessing:
    ...
    def test_batch_deidentify(self):
    ...
    def test_batch_performance(self):
        ...
        deidentifier = Deidentifier()
        texts = [
            f"Person {i}: Email is user{i}@example.com, Phone: (555) 123-{i:04d}, SSN: {100+i:03d}-{i:02d}-{1000+i:04d}"
            for i in range(1000)
        ]
...
class TestVerification:
    ...
    def test_verification_with_ssn(self):
...
class TestConvenienceFunctions:
    ...
    def test_deidentify_text_function(self):
    ...
    def test_verify_text_function(self):
...
class TestPerformance:
    ...
    def test_single_document_deidentification(self):
    ...
    def test_detection_without_pii(self):
