...
class AdvancedDataGenerator:
    ...
    def _select_with_weights(self, values: List[str], weights: Optional[List[float]] = None, count: int = 1) -> List[str]:
        """按权重选择值"""
        if weights is None:
        ...
        preset_configs = {
            "balanced": {
                "tech_stack": DimensionConfig(
                    name="tech_stack",
                    values=["Python", "Java", "Go", "Rust", "Node.js", "C#", "PHP", "Ruby",
                            "React", "Vue.js", "Angular", "PostgreSQL", "MongoDB", "Redis",
                            "Docker", "Kubernetes", "Terraform", "AWS", "Azure", "GCP"],
                    weights=[0.15, 0.15, 0.12, 0.08, 0.10, 0.08, 0.06, 0.04,
                            0.06, 0.05, 0.03, 0.12, 0.08, 0.06,
                            0.10, 0.08, 0.05, 0.12, 0.08, 0.05],
                    count_range=(5, 10)
                ),
                ...
                "location": DimensionConfig(
                    name="location",
                    values=["Remote", "San Francisco", "New York", "Seattle", "Beijing", "Shanghai", "London"],
                    count_range=(1, 1)
                ),
            }
        }
    ...
    def create_matching_config() -> GenerationConfig:
        ...
        resume_dims = {
            "skills": DimensionConfig(
                name="skills",
                values=["Python", "Java", "Go", "Kubernetes", "PostgreSQL", "MongoDB", 
                       "AWS", "Azure", "Docker", "React", "TensorFlow"],
            ...
            "previous_roles": DimensionConfig(
                name="previous_roles",
                values=["Backend Engineer", "DevOps", "Data Engineer", "ML Engineer", 
                       "Frontend", "Full Stack", "Engineering Manager"],
                count_range=(2, 4)
            ),
        }
...
def cli_main():
    ...
    parser.add_argument("--preset", choices=["tech_stack", "matching"], default="tech_stack",
                       help="使用预定义配置")
