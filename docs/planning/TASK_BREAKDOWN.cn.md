...
### 任务 1.5：准备可公开使用的示例数据集

**目标**
- [ ] 收集或生成可公开使用的示例数据（无隐私敏感信息）
- [ ] 创建 3 种数据类型：模拟简历（≥ 20 份）、招聘广告（≥ 15 份）、英语阅读理解题（≥ 50 题）
- [ ] 数据版本化管理和文档

**测试标准**
- [ ] 所有数据文件位于 data/public_samples/ 目录，结构清晰
- [ ] 模拟简历：格式规范，涵盖不同行业和职位
- [ ] 招聘广告：格式一致，包含岗位、要求、福利等完整信息
- [ ] 英语题目：格式标准，包含题目、选项、答案和解析
- [ ] 数据管理文档已更新（data/public_samples/README.md，中英文同步）
- [ ] 数据集可用于 RAG 系统评估和用户选择性测试
